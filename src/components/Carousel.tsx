            ...
            >
                <div class="carousel flex">
                    <For each={props.images}>
                        {(img) => (
                            <div class="carousel-item flex-shrink-0 w-full p-2 px-4 rounded-3xl card">
                                <img src={img.src} alt={img.alt} class="rounded-xl w-full object-cover p-1 glass-effect" />
                            </div>
                        )}
                    </For>
                </div>
